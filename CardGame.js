...
const getData = () => [
{ imgSrc: "./avengers.png", name: "avengers" },
{ imgSrc: "./blackwidow.png", name: "blackwidow" },
{ imgSrc: "./captainamerica.png", name: "captainamerica" },
{ imgSrc: "./hawkeye.png", name: "hawkeye" },
{ imgSrc: "./hulk.png", name: "hulk" },
{ imgSrc: "./ironman.png", name: "ironman" },
{ imgSrc: "./spiderman.png", name: "spiderman" },
{ imgSrc: "./thor.png", name: "thor" },
{ imgSrc: "./avengers.png", name: "avengers" },
{ imgSrc: "./blackwidow.png", name: "blackwidow" },
{ imgSrc: "./captainamerica.png", name: "captainamerica" },
{ imgSrc: "./hawkeye.png", name: "hawkeye" },
